...
export default {
  ...
  name: "Distribuidor",
        ...
        methods: {
           Search() { 
                    axios({ method: "GET", "url": "http://104.196.149.243:8085/buscarPorOrg?org=Distribuidor"}).then(result => {
        ...
        async send(){
          ...
          if(this.checkedMedicines.length == 1){
              await axios({ method: "GET", "url": "http://104.196.149.243:8085/enviarMedicina?id="+this.checkedMedicines[0]}).then(result=>{
             ...
             await axios({ method: "GET", "url": "http://104.196.149.243:8085/enviarLista?list="+this.checkedMedicinesString}).then(result=>{
